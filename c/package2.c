    ...
    for (int i=0 ; i< source->offices[source_office_index].packages_count ; i++){
        ...
        if(source->offices[source_office_index].packages[i].weight
            ...
            target->offices[target_office_index].min_weight){
                ...
                char* temp = (source->offices[source_office_index].packages[i].id);
                
                (source->offices[source_office_index].packages[i].id)=NULL;
                for(int k=i; k<(source->offices[source_office_index].packages_count)+1;k++){
           ...
           [target->offices[target_office_index].packages_count].id = temp;
