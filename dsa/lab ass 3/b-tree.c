...
void inorderTraversal(struct BTreeNode *myNode) {
  if (myNode) {
    ...
    for (i = 0; i < myNode->count; i++) {
      inorderTraversal(myNode->linker[i]);
...
// Postorder Traversal
void postorderTraversal(struct BTreeNode *myNode) {
  if (myNode) {
    int i;
    for (i = 0; i < myNode->count; i++) {
      postorderTraversal(myNode->linker[i]);
    }
    postorderTraversal(myNode->linker[i]);
...
// Preorder Traversal
void preorderTraversal(struct BTreeNode *myNode) {
  if (myNode) {
    int i;
    for (i = 1; i <= myNode->count; i++) {
      printf("%d ", myNode->item[i]);
    ...
    for (i = 0; i <= myNode->count; i++) {
      preorderTraversal(myNode->linker[i]);
    }
  }
}
